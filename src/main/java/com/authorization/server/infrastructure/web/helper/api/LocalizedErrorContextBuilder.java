...
/**
 * Builder class for creating instances of {@link LocalizedErrorContext} in a
 ...
 *
 */
public class LocalizedErrorContextBuilder {
     ...
     */
    public LocalizedErrorContextBuilder withFailedAction(String failedAction) {
     ...
     */
    public LocalizedErrorContextBuilder withReason(String reason) {
     ...
     */
    public LocalizedErrorContextBuilder withSeverity(String severity) {
     ...
     * @return this builder instance for method chaining.
     */
    public LocalizedErrorContextBuilder withHttpStatus(int httpStatus) {
     ...
     */
    public LocalizedErrorContextBuilder withLocale(Locale locale) {
    ...
    /**
     * Builds a {@link LocalizedErrorContext} instance with the configured properties.
     *
     ...
     * been set.
     *
     * @return a fully constructed {@link LocalizedErrorContext} instance.
     * @throws IllegalArgumentException if any required property is missing or null.
     */
    public LocalizedErrorContext build() {
        final LocalizedErrorContext errorContext = new LocalizedErrorContext();
