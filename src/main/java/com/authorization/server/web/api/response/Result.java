...
public class Result<T> {
     ...
     */
    private Result(T data, HttpStatus code, String token, String message, ValidationContext errors) {
     ...
     * @return builder.
     */
    public static <T> ResultBuilder<T> status(HttpStatus code) {
    ...
    public List<Message> getFlattenedErrors() {
        return ApiResponseHandler.flattenErrors(errors);
    }
    ...
    public static final class ResultBuilder<T> {
         ...
         * @return this builder.
         */
        public ResultBuilder<T> code(HttpStatus code) {
            this.code = code;
            return this;
        }
